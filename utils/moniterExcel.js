...
async function changeData(number) {
  return new Promise(async (resolve, reject)=> {
...
function moniterExcel(number) {
  return new Promise( async (resolve, reject)=> {
    var newObjArr = await changeData(number)
    // console.log(JSON.stringify(newObjArr))

    //入表
    var conf = {}
    conf.cols = [
      {caption: '设备编号', type: 'string', width: 10},
      {caption: '时间戳', type: 'string', width: 10},

      {caption: '空气入口压力PV', type: 'string', width: 15},
      {caption: '空气入口压力SV', type: 'string', width: 15},
      {caption: '空气瞬时流量', type: 'string', width: 15},
      {caption: '空气累计流量', type: 'string', width: 15},
      {caption: '油入口压力PV', type: 'string', width: 15},
      {caption: '油入口压力SV', type: 'string', width: 15},
      {caption: '油出口压力PV', type: 'string', width: 15},
      {caption: '油出口压力SV', type: 'string', width: 15},
      {caption: '油瞬时流量', type: 'string', width: 15},
      {caption: '油累计流量', type: 'string', width: 15},
      {caption: '入口水压力PV', type: 'string', width: 15},
      {caption: '入口水压力SV', type: 'string', width: 15},
      {caption: '出口水压力PV', type: 'string', width: 15},
      {caption: '出口水压力SV', type: 'string', width: 15},
      {caption: '水瞬时流量', type: 'string', width: 15},
      {caption: '水累计流量', type: 'string', width: 15},
      {caption: '已运行时间PV', type: 'string', width: 15},
      {caption: '保养时间间隔', type: 'string', width: 15},
      {caption: '燃烧室压力PV', type: 'string', width: 15},
      {caption: '热载体温度PV', type: 'string', width: 15},
      {caption: '热载体温度SV', type: 'string', width: 15},
      {caption: '热载体压力PV', type: 'string', width: 15},
      {caption: '热载体压力SV', type: 'string', width: 15},
      {caption: '冷却水温度PV', type: 'string', width: 15},
      {caption: '冷却水温度SV', type: 'string', width: 15},
      {caption: '空燃比PV', type: 'string', width: 15},
      {caption: '空燃比SV', type: 'string', width: 15},
      {caption: '油泵工作温度', type: 'string', width: 15},
      {caption: '油泵工作频率PV', type: 'string', width: 15},
      {caption: '油泵工作频率SV', type: 'string', width: 15},
      {caption: '油泵输入频率', type: 'string', width: 15},
      {caption: '水泵工作温度PV', type: 'string', width: 15},
      {caption: '水泵工作频率PV', type: 'string', width: 15},
      {caption: '水泵工作频率SV', type: 'string', width: 15},
      {caption: '水泵输入频率', type: 'string', width: 15},
      {caption: '加热水箱温度PV', type: 'string', width: 15},
      {caption: '加热水箱温度SVL', type: 'string', width: 15},
      {caption: '加热水箱温度SVH', type: 'string', width: 15},
      {caption: '相序正确开关', type: 'string', width: 15},
      {caption: '关闭阀', type: 'string', width: 15},
      {caption: '进原油，进柴油', type: 'string', width: 15},
      {caption: '水泵手自动', type: 'string', width: 15},
      {caption: '油泵手自动', type: 'string', width: 15},
      {caption: '排空阀开度', type: 'string', width: 15},
      {caption: '排空阀状态位', type: 'string', width: 15},
      {caption: '前置水泵状态位', type: 'string', width: 15},
      {caption: '水泵状态位', type: 'string', width: 15},
      {caption: '油泵状态位', type: 'string', width: 15},
      {caption: '点火器启停状态', type: 'string', width: 15},
      {caption: '柜顶风扇启停状态', type: 'string', width: 15},
      {caption: '排空阀启动位', type: 'string', width: 15},
      {caption: '排空阀停止位', type: 'string', width: 15},
      {caption: '排空阀开到位', type: 'string', width: 15},
      {caption: '排空阀关到位', type: 'string', width: 15},
      {caption: '加热器手自动', type: 'string', width: 15},
      {caption: '加热器1状态', type: 'string', width: 15},
      {caption: '加热器2状态', type: 'string', width: 15},
      {caption: '加热器3状态', type: 'string', width: 15},
    ]
